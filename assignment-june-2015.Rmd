...
`r appendix_num("app_sensor_columns", display="cite")`). So, I will try to
...
yielded an accuracy of `r round(cm_rf$overall["Accuracy"], 4)`
...
The model also has a high kappa statistic of `r round(cm_rf$overall["Kappa"], 4)`,
